...
<div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="{{route('dashboard.barang.stok',$barang->id)}}" method="post" id="formStok">
                @method('put')
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="{{$barang->stok_barang}}" name="jumlah">
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
                ...
                class="btn btn-primary ms-1" onclick="formConfirmation('Update Stok?','#formStok')">
                Tambah
            </button>
        </form>
        </div>
